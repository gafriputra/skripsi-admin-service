                        ...
                        <tbody>
                          <tr>
                            <td style="width:150px;">
                              <img alt="" height="auto" src="https://gafri.id/wp-content/uploads/2020/05/logo-biru-removebg-preview.png" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="150" />
                            </td>
                          </tr>
                        </tbody>
                      </table>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:30px;padding-left:25px;word-break:break-word;">
                      <div style="font-family:Playfair Display, Times New Roman, serif;font-size:30px;font-weight:bold;line-height:1;text-align:center;color:#071C4D;">Invoice Anda!</div>
                    </td>
                  </tr>
                </table>
              </div>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                          <tr>
                            <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                              <div style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:20px;text-align:left;color:#071C4D;">Hi, {{$data->name}} <br><br> Invoice digital kamu sudah berhasil dicetak. <br> Booking ID <strong>#{{$data->uuid}}</strong></div>
                            </td>
                          </tr>
                          <tr>
                            <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                            ...
                            <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                              <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#071C4D;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:28px;table-layout:auto;width:100%;border:none;">
                                ...
                                <tr>
                                  ...
                                  <td style="text-align: right;">Rp. {{number_format($data->shipping, 0, ',', '.')}}</td>
                                </tr>
                                <tr>
                                  <td><strong>Total Transaksi (+ tax 10 %)</strong></td>
                                  <td style="text-align: right;">Rp. {{number_format($data->transaction_total, 0, ',', '.')}}</td>
                                </tr>
                              </table>
                            </td>
                          </tr>
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                <tr>
                                  <td align="center" bgcolor="#FF9E53" role="presentation" style="border:none;border-radius:10px;cursor:auto;mso-padding-alt:10px 25px;background:#FF9E53;" valign="middle">
                                    <a href="{{url('invoice')}}" style="display:inline-block;background:#FF9E53;color:#ffffff;font-family:Assistant, Helvetica, Arial, sanf-serif;font-size:18px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;"> Check Detail </a>
                                  </td>
                                </tr>
                              </table>
                            </td>
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                        <tr>
                          <td style="width: 50px;">
                            <img src="https://gafri.id/wp-content/uploads/2020/05/logo-biru-removebg-preview.png" width="50px">
                          </td>
                          <td style="font-size: 18px; padding-left: 10px; color: #071C4D;font-family: Assistant, Helvetica, Arial, sans-serif"> admin@gafri.id <br> 0838-3011-6257 </td>
                        </tr>
                      </table>
                    </td>
                  </tr>
