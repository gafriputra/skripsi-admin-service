  ...
  <section class="ftco-section">
          <div class="container">
              <div class="row no-gutters">
                  <div class="col-md-5 p-md-5 img img-2 mt-5 mt-md-0" style="background-image: url({{asset('assets_cp/images/bg_2.jpg')}});">
                  </div>
          ...
          <p>Separated they live in. A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country</p>
              ...
              <div class="row">
                  <div class="col-md-6 col-lg-3 ftco-animate">
                      <div class="staff">
                          <div class="img-wrap d-flex align-items-stretch">
                              <div class="img align-self-stretch" style="background-image: url({{asset('assets_cp/images/team-1.j')}}pg);"></div>
                          </div>
                  ...
                  <div class="col-md-6 col-lg-3 ftco-animate">
                      <div class="staff">
                          <div class="img-wrap d-flex align-items-stretch">
                              <div class="img align-self-stretch" style="background-image: url({{asset('assets_cp/images/team-2.j')}}pg);"></div>
                          </div>
                          <div class="text pt-3 text-center">
                              <h3>Warren Parker</h3>
                  ...
                  <div class="col-md-6 col-lg-3 ftco-animate">
                      <div class="staff">
                          <div class="img-wrap d-flex align-items-stretch">
                              <div class="img align-self-stretch" style="background-image: url({{asset('assets_cp/images/team-3.j')}}pg);"></div>
                          </div>
                          <div class="text pt-3 text-center">
                              <h3>Eva Gustavo</h3>
                  ...
                  <div class="col-md-6 col-lg-3 ftco-animate">
                      <div class="staff">
                          <div class="img-wrap d-flex align-items-stretch">
                              <div class="img align-self-stretch" style="background-image: url({{asset('assets_cp/images/team-4.j')}}pg);"></div>
                          </div>
                          <div class="text pt-3 text-center">
